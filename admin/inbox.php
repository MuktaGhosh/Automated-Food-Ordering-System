                ...
                <div class="block">        
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<?php 
							if ($result['status'] == '0') { ?>
								<td><a style = "color:red;"  href="?shiftid=<?php echo $result['cmrId']; ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['date']; ?>">Shifted</a></td>
					<?php } elseif($result['status'] == '1') { ?>
							<td>N/A</td>
						<?php } elseif($result['status'] == '2') { ?>
                        	<td>N/A</td>
							<?php }else{ ?> 
                               <td><a  style = "color:red; "href="?delproid=<?php echo $result['cmrId']; ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['date']; ?>">Remove</a></td>
							<?php } ?> 
						</tr>
						<?php } } ?> 		
