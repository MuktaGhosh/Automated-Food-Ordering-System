<?php
    ...
    class User{
        ...
        public function isEmailUsernameExist($username, $email){
            ...
            $query = "select * from ".$this->db_table." where name = '$username' AND email = '$email'";
        ...
        public function createNewRegisterUser($username, $password, $email){
            ...
            $isValid = $this->isValidEmail($email);
                ...
                if($isValid)
                {
                $query = "insert into ".$this->db_table." (name, pass, email) values ('$username', '$password', '$email')";
